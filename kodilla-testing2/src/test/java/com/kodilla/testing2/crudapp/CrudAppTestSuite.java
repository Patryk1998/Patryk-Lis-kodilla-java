...
public class CrudAppTestSuite {
    private final static String BASE_URL = "https://patryk1998.github.io/tasks/";
    ...
    private void deleteTestTaskFromApplication(String taskName) throws InterruptedException {
        driver.switchTo().alert().accept();
        Thread.sleep(5000);
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(task -> task.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]")).getText().equals(taskName))
                .forEach(task -> {
                    task.findElement(By.xpath(".//button[4]")).click();
                });
    }
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("patron4@onet.pl");
